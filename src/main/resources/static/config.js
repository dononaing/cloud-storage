window.APP_CONFIG = {
    ...
    githubLink: "https://github.com/dononaing/cloud-storage",
    ...
    * */
    ...
    functions: {
        ...
        mapObjectToFrontFormat: (obj) => {
            ...
            let isDirectory = obj.type === "DIRECTORY"
            let name = obj.name
            if (isDirectory) {
                name = obj.name + "/"
            }
            return {
                ...
                name: name,
                size: obj.size,
                path: path + name, //путь в полном формате необходим для корректной навигации
